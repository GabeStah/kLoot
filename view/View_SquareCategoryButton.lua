...
function kLoot:View_SquareCategoryButton_Create(name, parent, category, headerText, subText, defaultColor, selectedColor, hoverColor)
...
function kLoot:View_SquareCategoryButton_ResetSelections(parent, category)
