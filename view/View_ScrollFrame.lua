...
function kLoot:View_ScrollFrame_Create(name, parent, width, height, defaultColor)
...
function kLoot:View_ScrollFrameScrollBar_Create(name, parent)
...
function kLoot:View_ScrollFrame_GetScrollTestData()
	local data = {}
	local characters = {
		'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 
		'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 
...
function kLoot:View_ScrollFrame_Update(frame)
	self:View_ScrollFrame_UpdateTest(frame)
end

--[[ Populate with test data
]]
function kLoot:View_ScrollFrame_UpdateTest(frame)
